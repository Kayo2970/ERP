              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-2.5 p-0.5 rounded text-theme-text-secondary hover:text-theme-text-primary transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-accent focus:outline-none"
