  ...
  (
    ...
    return (
      <button
        ...
        disabled={disabled}
        onClick={handleClick}
        className={`relative flex focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 items-center justify-center overflow-hidden cursor-pointer rounded-2xl px-5 py-2.5 font-semibold transition-all select-none active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none ${className}`}
        {...props}
      >
